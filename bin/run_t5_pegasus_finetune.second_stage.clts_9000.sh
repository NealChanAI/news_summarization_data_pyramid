...
function model_train() {
  ...
  python src/train/t5_pegasus_finetune.second_stage.clts.py \
  --train_data data/clts_data/train_formatted_clts_data.9000.txt \
  --dev_data data/clts_data/train_formatted_clts_data.1000.txt \
