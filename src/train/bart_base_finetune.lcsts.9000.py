...
SAVED_MODEL_PATH = osp.join(ROOT_DIR, 'model', 'chinese_bart_base_finetune_lcsts_9000')
...
if __name__ == '__main__':
    TRAIN_FILE_PATH = 'lcsts_train_formatted.9000.csv'  # 训练数据集
    VALIDATE_FILE_PATH = 'lcsts_train_formatted.1000.csv'  # 验证数据集
    training_workflow()
