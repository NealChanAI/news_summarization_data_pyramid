...
if __name__ == '__main__':
    ...
    LOG_FILE = osp.join(LOG_DIR, args.model_specific_dir, f'{args.version}.{args.stage}.predict.{current_time}.clts_stage1_9000.log')
    ...
    if args.stage.startswith('pretrain'):  # 加载预训练模型
        ...
        model_path = osp.join(args.model_dir, args.model_specific_dir, args.stage + '_' + args.version + '_' + 'clts_stage1_9000')
